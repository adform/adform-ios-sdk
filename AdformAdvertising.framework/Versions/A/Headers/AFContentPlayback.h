 ...
 */
static NSString *const kAFContentPlaybackStartedNotificaiton = @"kAFContentPlaybackStartedNotificaiton";
 ...
 */
static NSString *const kAFContentPlaybackFinishedNotificaiton = @"kAFContentPlaybackFinishedNotificaiton";
