...
/**
 Loads an ad in advance, to be able to display interstitial ad instantly. You display the ad with show method.
...
/**
 Use this method to load and display interstitial ads as pages.
